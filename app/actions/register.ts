      ...
      await transporter.sendMail({
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #eee; padding: 20px; border-radius: 10px;">
            ...
            <p>We are so excited to have you join us for a two days event packed with real fun, real vibes, and real essence. Get ready for an unforgettable fusion of food, music, and culture.</p>
